...
const { FREE_USER_LIMIT } = process.env;
...
exports.register = async (req, res) => {
  ...
  try {
    ...
    if (userCount >= parseInt(FREE_USER_LIMIT) && process.env.NODE_ENV !== 'development') { // Exclui dev para facilitar testes
    ...
    const newUser = await User.create({ username, email, password }); // A senha será hashed pelo hook do modelo
